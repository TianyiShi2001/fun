...
for(i in 题材){
  filename = str_c('data/crawl/tuchong/', i, '/data/tag_info.csv')
...
post_info <- tibble()
for(i in 题材){
  filename = str_c('data/crawl/tuchong/', i, '/data/post_info.csv')
...
ggsave('tuchong.png', width = 10, height = 15, dpi=600, scale = 0.8)
